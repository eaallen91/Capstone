...
def align3D(dnaSeq1, dnaSeq2, dnaSeq3, gap, mismatch, match):
    ...
    for level in range(1, len(dnaMatrix3)):
        ...
        for col in range(1, len(dnaMatrix1)):
            ...
            scoringMatrix[level][0][col] = min(scoringMatrix[level][0][col-1] + (gap*2),
        ...
        for row in range(1, len(dnaMatrix2)):
            ...
            if dnaMatrix2[row] == dnaMatrix3[level]:
                ...
                singleGap = singleGap + mismatch
            scoringMatrix[level][row][0] = min(scoringMatrix[level][row-1][0] + (gap*2),
    ...
    for col in range(1, len(dnaMatrix1)):
        for row in range(1, len(dnaMatrix2)):
            ...
            scoringMatrix[0][row][col] = min(scoringMatrix[0][row][col-1] + (gap*2),
    ...
    for level in range(1, len(dnaMatrix3)):
        for col in range(1, len(dnaMatrix1)):
            for row in range(1, len(dnaMatrix2)):
                ...
                scoringMatrix[level][row][col] = min(scoringMatrix[level][row][col-1] + (gap*2),    ## Case 1
