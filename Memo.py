...
optimal solution
'''
def align3D(dnaSeq1, dnaSeq2, dnaSeq3, gap, mismatch, match, minMax):
            ...
            for row in range(0, len(dnaMatrix2)):
                ...
                if level == 0:
                    if (row == 0) and (col == 0):
                        ...
                        scoringMatrix[level][row][col] = scoringMatrix[level][row][col-1] + (gap*2)
                        memoMatrix[level][row][col] = 1
                    elif col == 0:
                        scoringMatrix[level][row][col] = scoringMatrix[level][row-1][col] + (gap*2)
                ...
                ### the cells in the matricies will be the final else.
                    ...
                    if (row == 0) and (col == 0):
                        scoringMatrix[level][row][col] = scoringMatrix[level-1][row][col]
